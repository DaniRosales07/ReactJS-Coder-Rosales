...
function Section5() {
  ...
  // Filtrar los datos para tomar solo los IDs 10, 11 y 12
  const filteredCardData = cardData.filter(service => [10, 11, 12].includes(service.id));

  return (
    <section className="fondo-blanco centrar-contenido">
      <h2 className="titulosh1">Academia y Capacitaciones TEM</h2>
      <h3 className="centrar-texto espacio-texto">Capacitate de manera online para dar un salto en tu carrera laboral</h3>
