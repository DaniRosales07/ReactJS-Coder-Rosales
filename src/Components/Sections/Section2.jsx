...
function Section2() {
  ...
  const filteredCardData = cardData.filter(service => service.id === 1 || service.id === 2 || service.id === 3);

  return (
    <section className="fondo-blanco centrar-contenido">
      <h2 className="titulosh1">Servicios de Búsqueda Laboral</h2>
      <h3 className="centrar-texto espacio-texto">Todas las herramientas que necesitas para encontrar tu nuevo trabajo</h3>

      <div className="card-container2">
        {filteredCardData.map(service => (
          <div key={service.id} className="card-principal">
            <img src={service.imageUrl} alt="" className="imagen-redonda" />
